...
//                                            CheckConnection.ShowToast_Short(getApplicationContext(), "Thay đổi mật khẩu thành công");
//                                            alertDialog1.cancel();
//                                            alertDialog.cancel();
//                                            getData();   //cập nhật lại thông tin sau khi đổi mật khẩu
//                                        } else {
//                                            CheckConnection.ShowToast_Short(getApplicationContext(), "Nhập lại mật khẩu mới không chính xác!");
//                                        }
//                                    } else {
...
//                            alertDialog1.show();
//                        } else {
//                            CheckConnection.ShowToast_Short(getApplicationContext(), "Sai mật khẩu!");
//                        }
//                    }
//                });
...
//                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Bạn đang dùng họ tên này");
//                                        etHoTenMoi.setText("");
//                                    }
//                                    else if (etSdtMoi.getText().toString().trim().equals(db_sdt)) {
//                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Bạn đang dùng số điện thoại này");
//                                        etSdtMoi.setText("");
//                                    }
//                                    else if (etEmailMoi.getText().toString().trim().equals(db_email)) {
//                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Bạn đang dùng địa chỉ email này");
//                                        etEmailMoi.setText("");
//                                    }
//
...
//                                    {
//                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Địa chỉ email không hợp lệ!");
//                                        etEmailMoi.setText("");
//                                    }
...
//                                                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Số điện thoại này đã được sử dụng!");
//                                                                        etSdtMoi.setText("");
//                                                                        break;
//                                                                    } else if (etEmailMoi.getText().toString().trim().equals(dbEmail)) {
//                                                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Địa chỉ email này đã được sử dụng!");
//                                                                        etEmailMoi.setText("");
//                                                                        break;
//                                                                    }
//                                                                } catch (JSONException e) {
...
//                                                                    CheckConnection.ShowToast_Short(getApplicationContext(), "Thay đổi thông tin thành công");
//                                                                    getData();
//                                                                    alertDialog2.cancel();
//                                                                    alertDialog.cancel();
//                                                                }
...
//
//                                    } else {
//                                        CheckConnection.ShowToast_Short(getApplicationContext(), "Hãy nhập ít nhất  một thông tin mới!");
//                                    }
//                                }
//                            });
