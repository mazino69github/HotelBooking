        ...
        button_xacnhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (d_ngaynhan.getTime() == d_ngaytra.getTime() || d_ngaynhan.getTime() > d_ngaytra.getTime()
                    ...
                    CheckConnection.ShowToast_Short(getApplicationContext(), "Bạn cần chọn ngày cho " + MainActivity.arr_giohang.get(position).getSodem() + " đêm");
                } else {
                    if (KiemTraNgay(d_ngaynhan, d_ngaytra)) {
                        ...
                        CheckConnection.ShowToast_Short(getApplicationContext(), "Bạn đã chọn ngày này ở khách sạn khác");
                }
            }
        });
    }
