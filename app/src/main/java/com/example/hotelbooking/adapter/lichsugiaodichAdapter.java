...
public class lichsugiaodichAdapter extends BaseAdapter {
    Context context;
    ArrayList<ChiTietDatPhong> arr_lichsugiaodich;

    public lichsugiaodichAdapter(Context context, ArrayList<ChiTietDatPhong> arr_lichsugiaodich) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ChiTietDatPhong chitietdatphong = (ChiTietDatPhong) getItem(position);
